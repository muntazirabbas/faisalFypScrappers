...
def getAllLinks():
    scrapeUrl = "https://outfitters.com.pk/pages/men"
    driver.get(scrapeUrl)
    
    soup = BeautifulSoup(driver.page_source,'html.parser')
    print('soup ', soup)
    menSoup = soup.findAll('li', attrs={'class': 'menu-lv-3'}) #[0].findAll('li', attrs={'class' : 'mb-sub-link level-2'})
    # womenSoup = soup.findAll('ul', attrs={'class': 'col-1 parent-mega-menu'})[1].findAll('li', attrs={'class' : 'mb-sub-link level-2'})
    # kidsSoup = soup.findAll('ul', attrs={'class': 'col-1 parent-mega-menu'})[1].findAll('li', attrs={'class' : 'mb-sub-link level-2'})
