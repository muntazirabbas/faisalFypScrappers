    ...
    if(soup.find('ul',attrs={'class' : 'products product-grid gutters row clearfix columns-4'})):
        ...
        for product in products:
            ...
            if(productDetails.find('span', attrs={'class' : 'price'})):
                price = float(productDetails.find('span', attrs={'class' : 'price'}).findAll('span', attrs={'class' : 'woocommerce-Price-amount amount'})[-1].text.strip()[2:].replace(',',''))
